      ...
      {!extensionDetected && !loading && (
        ...
        >
          ...
          <div style={{
            ...
            1. Download the extension from GitHub<br />
            ...
            4. Click "Load unpacked" → select the <code style={{ background: "#f0f0f0", padding: "1px 6px", borderRadius: "4px", fontSize: "11px" }}>extension</code> folder
          </div>
          <a
